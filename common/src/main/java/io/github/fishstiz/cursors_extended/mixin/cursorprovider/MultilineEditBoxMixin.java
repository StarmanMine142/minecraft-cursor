...
public abstract class MultilineEditBoxMixin extends AbstractWidget implements CursorProvider {
    protected MultilineEditBoxMixin(int x, int y, int width, int height, Component message) {
